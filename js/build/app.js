...
var svgIconConfig = {
    hamburgerCross : {
        url : '../wp-content/themes/famo/img/svg/hamburger.svg',
        animation : [
            { 
                el : 'path:nth-child(1)', 
                animProperties : { 
